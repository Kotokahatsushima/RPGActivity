...
public class Driver
{
    ...
    public class Archer
    {
        public double max_health, health, damage, speed, exp, gold;
...
First Skill: {8}
Second Skill: {9}
Ultimate Skill: {10}", health, damage, speed, gold, exp, level, job, name, first_skill, second_skill, ultimate_skill);
        }
...
3: Exit Guild Medical Facility");
                ...
                switch(input_choice)
                {
                    ...
                    case 2:
                        ...
                        {
                            Console.WriteLine("----------------------------------");
                            Console.WriteLine("Your skill charges are now all full");
                            Console.WriteLine("----------------------------------");
                            user.first_skill = 10;
    ...
    public static void FightSceneEnemyFirst(dynamic user, dynamic enemy)
    {
        while(user.health > 0 && enemy.health > 0)
        {
            ...
            if(user.health <= 0)
            {
                ...
                Console.WriteLine("Press Enter to enter to restart...");
                Console.ReadLine();
                Main();
            }
